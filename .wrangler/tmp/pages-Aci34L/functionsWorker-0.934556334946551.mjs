...
async function onRequestPost({ request, env }) {
  try {
    ...
    if (!email && !phone) {
      return new Response(JSON.stringify({ error: "Email ou telefone \xE9 obrigat\xF3rio" }), {
        status: 400,
    ...
    console.error("Erro na integra\xE7\xE3o GHL:", error);
...
// ../.wrangler/tmp/pages-Aci34L/functionsRoutes-0.2736417736967611.mjs
var routes = [
  {
    routePath: "/api/lead",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-p7vMin/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-p7vMin/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.934556334946551.mjs.map
